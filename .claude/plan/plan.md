...
### ☀️ 紫外線指數服務 ⚠️ 待重新實作 (30%)

- **需要創建**: UVBot + 對應 adapter
- **觸發詞**: "紫外線"、"需要防曬嗎"
...
_最後更新: 2026-03-26_
_專案狀態: 天氣、淺草籤詩、空氣品質、地震資訊、放假日查詢系統完整實作完成，架構框架完善_
_下階段目標: 完成剩餘 1 個 Bot 實作（UV），整合 LINE 選單系統_
_開發重點: 參考 HolidayBot / EarthquakeBot 模式，快速完成 UVBot 實作_
